    ...
    <div class="container-table100">
        <div class="wrap-table100"></div>
            <table class="table table-bordered">
                ...
                <?php
                $myrow = $obj->fetch_record("category");
                foreach ($myrow as $row) {
                    ...
                    <tr>
                        ...
                        <td><a href="edit.php?update=1&categoryID=<?php echo $row["categoryID"]; ?>"
                               class="btn btn-info">Edit</a></td>
                        <td><a href="action.php?delete=1&categoryID=<?php echo $row["categoryID"]; ?>" class="btn btn-danger">Delete</a>
                        </td>
