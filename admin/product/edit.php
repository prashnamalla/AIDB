...
<form method="post" action="action.php">
    <table class="table table-hover">
        <tr>
            <td><input type="hidden" name="productID" value="<?php echo $id; ?>"></td>
        </tr>
        <tr>
            <td>Product Name</td>
            <td><input type="text" class="form-control" value="<?php echo $row["pname"]; ?>" name="pname" placeholder="Enter Product Name" required></td>
        </tr>

        <tr>
            <td>Product Price</td>
            <td><input type="text" class="form-control" value="<?php echo $row["price"]; ?>" name="price" placeholder="Enter Product Price" required></td>
        </tr>
        ...
        <tr>
            ...
            <td><textarea value="<?php echo $row["detail"]; ?>" name="detail" placeholder="Enter Product Details" required></textarea></td>
        </tr>

        <tr>
            <td colspan="2" align="center"><input type="submit" class="btn btn-primary" name="edit" value="Update" required></td>
        </tr>
    </table>
</form>
